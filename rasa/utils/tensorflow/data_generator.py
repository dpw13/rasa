...
class RasaBatchDataGenerator(RasaDataGenerator):
    ...
    def __len__(self) -> int:
        ...
        # This previously dropped batches less than half full. It's not at all clear
        # why that would be desirable, because some set (up to batch size/2) entries
        # just get dropped. Instead just take the ceiling to determine the number of
        # batches.
