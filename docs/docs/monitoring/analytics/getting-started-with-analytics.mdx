...
description: Visualise and process Rasa assistant metrics in the
  tooling of choice.
---
...
[Installation and Configuration](/deploy/deploy-rasa-pro-services#installation-and-configuration).
...
[**Connect an assistant** section](#1-connect-an-assistant) you must enter
...
[environment variable `RASA_ANALYTICS_DB_URL`](../../deploy/deploy-rasa-pro-services#docker-container-configuration-reference)
